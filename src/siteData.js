...
export const services = {
  "/digital/websites-erstellen-lassen": {
    ...
    pricing: [
      { name: "Website Starter", price: "1.950 €", duration: "ca. 3–6 Wochen", meta: "bis 5 Seiten · 2 Korrekturrunden" },
      { name: "Website Business", price: "2.950 €", duration: "ca. 4–8 Wochen", meta: "bis 10 Seiten · Branding · Tracking-Grundsetup" },
      { name: "Website Pro", price: "4.500 €", duration: "nach Absprache", meta: "bis 15 Seiten · Conversion · Blog · Newsletter", featured: true },
      { name: "Website Individual", price: "ab 4.900 €", duration: "nach Absprache", meta: "individuelle UX/UI und Funktionen" },
    ],
