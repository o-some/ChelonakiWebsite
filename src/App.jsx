...
const labEntries = [
  ...
  { title: "Telefonassistent-Beispiele", status: "Ablauf als Vorlage", category: "Systeme", area: "KI-Telefonassistenten", text: "Sehen Sie beispielhafte Gesprächswege für Begrüßung, Anliegen, Terminübergabe und Eskalation. Die spätere Logik wird auf Ihren Betrieb angepasst.", image: "/assets/design-phone.png", href: "/medien-ai/ki-telefon" },
  ...
  { title: "Lernwelt-Beispiele", status: "Als Vorlage wählbar", category: "Lernwelten", area: "Academy & Schulung", text: "Wählen Sie eine Lernwelt für Kurse, Module, Fortschritt und Arbeitsmaterialien. Didaktik und Inhalte werden separat auf Ihr Ziel abgestimmt.", image: "/assets/design-training.png", href: "/ki-beratung-weiterbildung/video-academy" },
  { title: "Beratungswelten", status: "Ablauf als Vorlage", category: "Systeme", area: "KI-Beratung", text: "Beispielhafte Workshop- und Strategieformate zeigen, wie Analyse, Priorisierung und Roadmap visuell verständlich aufgebaut werden können.", image: "/assets/design-consulting.png", href: "/ki-beratung-weiterbildung/ki-beratung-unternehmen" },
  { title: "Originals-Präsentationen", status: "Inspiration", category: "Originals", area: "Eigene Apps & Bücher", text: "Entdecken Sie, wie eigene Apps und Bücher hochwertig präsentiert werden können – als Inspiration für Produktseiten und persönliche Markenwelten.", image: "/assets/design-originals.png", href: "/originals" },
];
