...
function Pricing({ data }) {
  ...
  const commonFeatures = data.commonFeatures || ["Persönliches Briefing", "Schriftlich definierter Leistungsumfang", "Menschliche Qualitätskontrolle und Freigabe"];
  ...
  const cardFeatures = (tier) => [...commonFeatures, ...(inheritedFrom(tier) ? [`Alle Leistungen aus ${inheritedFrom(tier).name}`] : []), ...ownFeatures(tier)];
