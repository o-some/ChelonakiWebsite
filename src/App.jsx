...
function OriginalAppsPage() {
  return <main id="main"><section className="original-hero"><span className="audience-label">Chelonaki Original</span><h1>Digitale Begleiter, die Wissen in Handlung verwandeln.</h1><p>Unter Chelonaki Originals entstehen eigene Apps für Ernährung, Fitness, Lernen, Kommunikation und einen leichteren Alltag.</p></section><section className="product-pair"><SmartLink href="/originals/apps/evofit"><span>Prototyp</span><h2>Chelonaki EvoFit</h2><p>Trainingsplanung, Ernährung, Rezepte, Einkauf, Challenges und langfristige Motivation in einer verbundenen Welt.</p><ArrowUpRight size={22}/></SmartLink><SmartLink href="/originals/apps/chelonaki-reply"><span>In Entwicklung</span><h2>Chelonaki Reply</h2><p>Drei passende Antwortvorschläge für LinkedIn, Instagram und E-Mail – mit menschlicher Freigabe als letztem Schritt.</p><ArrowUpRight size={22}/></SmartLink></section></main>;
}
