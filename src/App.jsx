...
import { ArrowRight, ArrowUpRight, Buildings, CaretDown, Check, ChatCircleDots, EnvelopeSimple, GlobeHemisphereWest, List, LockKey, MagnifyingGlassMinus, MagnifyingGlassPlus, PaperPlaneTilt, Sparkle, X } from "@phosphor-icons/react";
...
const labEntries = [
  { title: "Botanical Ember", status: "Buchvorlage 141", category: "Bücher", area: "Kochbuch · Botanisch", text: "Eine helle, florale Editorialwelt mit feiner Serifentypografie, botanischen Illustrationen und ruhiger Rezeptdramaturgie.", details: "Besonders passend für Kochbücher, Kräuterwissen, Gartenküche, Wellness und hochwertige Food-Marken. Enthalten sind Gestaltungsrichtungen für Cover, Vorwort, Inhaltsverzeichnis, Philosophie, Zutaten, Technik, Rezepte und Autorenprofil.", image: "/assets/book-designs/design-1.png", href: "/web-apps-publikationen/buecher-erstellen-lassen-ghostwriting" },
  { title: "Sunset Table", status: "Buchvorlage 140", category: "Bücher", area: "Kochbuch · Modern", text: "Warme Abendstimmung, kräftige Headlines und eine moderne Bildsprache für gesellige, charakterstarke Genussbücher.", details: "Ideal für Barbecue, Outdoor Cooking, Gastgeberkonzepte und persönliche Kochmarken. Das System verbindet große Food-Fotografie mit klaren Zutaten-, Technik- und Storytellingseiten.", image: "/assets/book-designs/design-2.png", href: "/web-apps-publikationen/buecher-erstellen-lassen-ghostwriting" },
  { title: "Olive & Coal", status: "Buchvorlage 139", category: "Bücher", area: "Kochbuch · Mediterran", text: "Naturstein, Olivgrün und warme Erdtöne verbinden mediterrane Herkunft mit einem zeitlosen, hochwertigen Buchauftritt.", details: "Geeignet für mediterrane Küche, Familienrezepte, Produktwelten und kulinarische Herkunftsgeschichten. Die Vorlage bietet viel Raum für Zutatenkunde, Rezepte, Pairings und Persönlichkeit.", image: "/assets/book-designs/design-3.png", href: "/web-apps-publikationen/buecher-erstellen-lassen-ghostwriting" },
  { title: "Poolside Ritual", status: "Buchvorlage 138", category: "Bücher", area: "Kochbuch · Editorial Pop", text: "Türkis, Koralle und starke Kontraste erzeugen eine lebendige Sommerwelt, ohne die Lesbarkeit der Rezepte zu verlieren.", details: "Eine passende Richtung für moderne Grillbücher, Creator, Lifestyle-Marken und sommerliche Produktkampagnen. Flexible Module tragen Rezepte, Tipps, Saucen, Storys und Personenporträts.", image: "/assets/book-designs/design-4.png", href: "/web-apps-publikationen/buecher-erstellen-lassen-ghostwriting" },
  { title: "Nordic Firelight", status: "Buchvorlage 137", category: "Bücher", area: "Kochbuch · Skandinavisch", text: "Kühle Naturtöne, großzügiger Weißraum und zurückhaltende Goldakzente schaffen eine besonders ruhige Premiumwirkung.", details: "Empfohlen für nordische Küche, Fisch, Natur, Longevity und reduzierte Fachbücher. Das Layout führt elegant durch Philosophie, Zutaten, Technik, Rezepte und Autorenprofil.", image: "/assets/book-designs/design-5.png", href: "/web-apps-publikationen/buecher-erstellen-lassen-ghostwriting" },
  { title: "Botanical Atelier", status: "Interaktive Webvorlage 03", category: "Webseiten", area: "Wellness · Food · Beratung", text: "Eine helle, botanische Landingpage mit großzügiger Editorialtypografie, ruhigen Inhaltsblöcken und organischer Bildsprache.", details: "Aus Botanical Ember als digitale Markenwelt weitergedacht: ideal für Ernährungsberatung, Wellness, hochwertige Lebensmittel und persönliche Expertenmarken. Testen Sie Farben und Bereiche direkt in der interaktiven Ansicht.", image: "/assets/book-designs/design-1.png", href: "/web-apps-publikationen/websites-erstellen-lassen", webTheme: "botanical", palettes: [["#F6F1E8","#17362C","#9BAD91","#C88E61","#2B302C"],["#FFF9F0","#4B2636","#D6A6A1","#B68A5A","#201A1D"],["#F2F1EA","#17324B","#A5B8C6","#D1B06B","#182029"]] },
  { title: "Olive & Stone", status: "Interaktive Webvorlage 02", category: "Webseiten", area: "Gastronomie · Hotel · Genuss", text: "Mediterraner Naturstein, Olivgrün und warme Erdtöne ergeben eine charakterstarke Premium-Landingpage.", details: "Die Buchwelt Olive & Coal wird zu einer digitalen Erlebnisfläche mit Storytelling, Angeboten, Herkunft und klarer Anfrageführung. Passend für Hotels, Restaurants, Manufakturen und Genussmarken.", image: "/assets/book-designs/design-3.png", href: "/web-apps-publikationen/websites-erstellen-lassen", webTheme: "olive", palettes: [["#EEE9DE","#29372B","#8C8A61","#B9814D","#171D1A"],["#F4E8D5","#402B25","#B56D4E","#D2AE73","#251C19"],["#E9ECE7","#153747","#7699A1","#C7A35F","#12232A"],["#F1EDE5","#332D49","#8C79A4","#C99B63","#1B1923"]] },
  { title: "Poolside Studio", status: "Interaktive Webvorlage 01", category: "Webseiten", area: "Creator · Lifestyle · Events", text: "Eine lebendige Editorial-Landingpage mit starken Kontrasten, modularen Geschichten und klaren Call-to-Actions.", details: "Aus Poolside Ritual entsteht eine moderne Website für Creator, Events, Lifestyle-Produkte und mutige persönliche Marken. Die Farbwelten reichen von sommerlich bis elegant-dunkel.", image: "/assets/book-designs/design-4.png", href: "/web-apps-publikationen/websites-erstellen-lassen", webTheme: "poolside", palettes: [["#F6E8DB","#0D5961","#38A9A3","#ED765F","#172B33"],["#F7F2E8","#243B6B","#E7B64A","#E06B57","#16213A"],["#F0E9E1","#562E47","#D8879A","#D4A85C","#291B25"],["#ECE8DF","#142A3A","#648EA3","#C59B5D","#0E1921"],["#F8EFE5","#28524C","#9AC0A5","#EF8D69","#20312F"]] },
  { title: "App-Designbeispiele", status: "Als Vorlage wählbar", category: "Apps", area: "Apps & Software", text: "Wählen Sie eine Richtung für Navigation, Dashboards und Nutzerführung. Funktionen und Oberfläche entstehen danach passend zu Ihrem Produkt.", image: "/assets/design-apps.png", href: "/web-apps-publikationen/apps-entwickeln-lassen" },
  { title: "Content-Designbeispiele", status: "Als Vorlage wählbar", category: "Content", area: "Content & Social Media", text: "Vergleichen Sie unterschiedliche Gestaltungswelten für Beiträge, Karussells und Kurzvideos – als Ausgangspunkt für einen konsistenten Markenauftritt.", image: "/assets/design-content.png", href: "/medien-ai/social-media" },
  { title: "Anzeigen-Designbeispiele", status: "Als Vorlage wählbar", category: "Content", area: "Meta & Google Ads", text: "Entdecken Sie Creative-Richtungen für aufmerksamkeitsstarke Anzeigen. Motive, Formate und Botschaften werden für Ihr Angebot neu entwickelt.", image: "/assets/design-ads.png", href: "/medien-ai/ads" },
  { title: "Reply-Oberflächenbeispiele", status: "Als Vorlage wählbar", category: "Apps", area: "KI-Antworten", text: "Vergleichen Sie ruhige, kompakte Bedienkonzepte für Antwortvorschläge und menschliche Freigabe auf Social Media und im E-Mail-Alltag.", image: "/assets/design-reply.png", href: "/medien-ai/chelonaki-reply" },
];
...
function HubPage({ type }) {
  ...
  return <main id="main"><section className={`page-hero page-hero-${type}`}><div><span className="audience-label"><Buildings size={15}/>{data.label}</span><h1>{data.title}</h1><p>{data.intro}</p><div className="page-hero-actions"><SmartLink className="button button-gold" href={`/kontakt?bereich=${type}`}>{data.cta}<ArrowRight size={18}/></SmartLink><SmartLink className="text-link text-link-light" href="/paketfinder">Passende Lösung finden <ArrowRight size={18}/></SmartLink></div></div><figure><img src={type === "originals" ? "/assets/originals-editorial.webp" : data.image} alt="Chelonaki Markenwelt" width="1536" height="1024"/></figure></section><section className="service-index"><header><span>Entdecken</span><h2>Womit möchten Sie beginnen?</h2><p className="section-lead">Öffnen Sie den Bereich, der Ihrem Ziel am nächsten kommt. Dort finden Sie Leistungsumfang, Vorgehen, Preise, Voraussetzungen und den passenden nächsten Schritt.</p></header><div>{data.cards.map((card, i) => <SmartLink className="service-index-card" href={card.href} key={card.href}><span>0{i+1}</span>{card.image && <figure><img src={card.image} alt="" loading="lazy" width="1536" height="1024"/></figure>}<h3>{card.title}</h3><p>{card.text}</p><small>Leistung, Ablauf und Möglichkeiten ansehen</small><ArrowUpRight size={21}/></SmartLink>)}</div></section><HubDecision data={data}/>{type === "expertise" && <Credentials/>}<Process/><FinalCta label={data.cta}/></main>;
}

function HubDecision({ data }) {
  return <section className="hub-decision"><figure><img src="/assets/service-funnel-editorial.webp" alt="Helle griechische Architektur als Symbol für klare, tragfähige Lösungen" loading="lazy"/></figure><div><span>Orientierung vor der Anfrage</span><h2>Sie müssen noch nicht wissen, welches Paket Sie brauchen.</h2><p>Entscheidend ist zunächst, welches Ergebnis Sie erreichen möchten. Wir ordnen Ziel, Ausgangslage, Budget und Zeitrahmen ein und empfehlen nur den Umfang, der für den nächsten sinnvollen Schritt erforderlich ist.</p><ol><li><b>01</b><span><strong>Ziel beschreiben</strong>Was soll für Kunden, Mitarbeiter oder Nutzer konkret besser werden?</span></li><li><b>02</b><span><strong>Ausgangslage prüfen</strong>Welche Inhalte, Systeme, Zugänge oder Ideen sind bereits vorhanden?</span></li><li><b>03</b><span><strong>Passenden Einstieg wählen</strong>Kleiner Start, belastbares Kernprodukt oder individuelle Lösung.</span></li></ol><SmartLink className="button button-navy" href="/paketfinder">Unverbindliche Empfehlung erhalten <ArrowRight size={18}/></SmartLink></div></section>;
}

function ServicePage({ data }) {
  return <main id="main"><section className="service-hero"><div className="service-hero-copy"><span className="audience-label"><Buildings size={15}/>{data.label}</span><small>{data.area}</small><h1>{data.title}</h1><p>{data.intro}</p><div className="page-hero-actions"><SmartLink className="button button-gold" href={`/kontakt?bereich=${encodeURIComponent(data.bookingCta || data.cta)}`}>{data.bookingCta || data.cta}<ArrowRight size={18}/></SmartLink><a className="text-link text-link-light" href="#leistung">Leistung vollständig prüfen <ArrowRight size={18}/></a></div><div className="hero-assurances"><span><Check size={15}/>Klarer Leistungsumfang</span><span><Check size={15}/>Menschliche Freigabe</span><span><Check size={15}/>Nachvollziehbare Übergabe</span></div>{data.bookingCta && <p className="booking-status">Die direkte Shopify-Buchung wird nach Anlage der finalen Produkte und rechtlichen Freigaben aktiviert.</p>}</div><figure><img src={data.image || "/assets/service-funnel-editorial.webp"} alt={data.imageAlt || "Hochwertige griechisch inspirierte Architektur als Chelonaki Projektwelt"} width="1536" height="1024"/></figure></section><section className="problem-solution" id="leistung"><div><span>Ausgangssituation</span><h2>{data.problem}</h2><p>Das Ziel ist nicht mehr Technik oder mehr Content, sondern ein Ergebnis, das im Alltag verständlich eingesetzt, geprüft und weiterentwickelt werden kann.</p></div><div><span>Die Lösung</span><ul>{data.solution.map((item) => <li key={item}><Check size={18}/>{item}</li>)}</ul></div></section><ConversionBridge data={data}/>{data.insight && <section className="platform-section"><div><span>{data.insight.label}</span><h2>{data.insight.title}</h2><p>{data.insight.text}</p></div><ul>{data.insight.points.map((point) => <li key={point}><Check size={18}/>{point}</li>)}</ul></section>}<Deliverables data={data}/><Process items={data.steps}/><MidFunnelCta data={data}/><ProjectReadiness data={data}/><Pricing data={data}/><ServiceFaq data={data}/><FinalCta label={data.inquiryCta || data.cta}/></main>;
}

function ConversionBridge({ data }) {
  const outcomes = data.outcomes || ["Ein klar definiertes Ergebnis statt eines offenen Technikprojekts", "Ein abgestimmter Umfang mit transparenten Grenzen und Zuständigkeiten", "Ein früher prüfbarer Stand, bevor unnötig Zeit und Budget gebunden werden", "Eine dokumentierte, nutzbare Übergabe mit verständlichen nächsten Schritten"];
  return <section className="conversion-bridge"><header><span>Was Sie am Ende erhalten</span><h2>Vom Versprechen zum überprüfbaren Ergebnis.</h2><p>Vor dem Start wird festgehalten, was geliefert, geprüft und übergeben wird. So können Sie Leistung, Fortschritt und nächste Entscheidungen nachvollziehen.</p></header><div>{outcomes.map((item, i) => <article key={item}><b>0{i + 1}</b><p>{item}</p></article>)}</div></section>;
}

function Deliverables({ data }) {
  return <section className="deliverables-section"><div><span>Leistung & Qualitätskontrolle</span><h2>Was im Projekt konkret passiert.</h2><p>Die Umsetzung wird in nachvollziehbare Bausteine zerlegt. Inhalte und Funktionen werden nicht ungeprüft veröffentlicht; relevante Grenzen und Fremdkosten werden vorab benannt.</p><SmartLink className="text-link" href="/qualitaet">Chelonaki Qualitätsrahmen ansehen <ArrowRight size={18}/></SmartLink></div><div className="deliverables-grid">{data.solution.map((item, i) => <article key={item}><span>{String(i + 1).padStart(2, "0")}</span><h3>{item}</h3><p>{["Ziel, Umfang und Abnahmekriterien werden vor der Umsetzung gemeinsam festgehalten.", "Ein früher Stand macht Richtung, Inhalt und Bedienung rechtzeitig prüfbar.", "Korrekturen werden gebündelt eingearbeitet und wesentliche Entscheidungen dokumentiert.", "Sie erhalten eine verständliche Übergabe sowie Empfehlungen für Betrieb und Ausbau."][i % 4]}</p></article>)}</div></section>;
}

function MidFunnelCta({ data }) {
  return <section className="mid-funnel-cta"><figure><img src="/assets/service-funnel-editorial.webp" alt="Mediterrane Architektur mit klarer räumlicher Führung" loading="lazy"/></figure><div><span>Ohne Verkaufsdruck einordnen</span><h2>Ist diese Lösung für Ihr Vorhaben sinnvoll?</h2><p>Schildern Sie kurz Ziel, Ausgangslage und gewünschten Start. Sie erhalten eine ehrliche Einordnung, welches Paket passt, wo Individualisierung nötig ist und welche Grundlagen vor Projektbeginn fehlen.</p><ul><li><Check size={17}/>Keine automatische Bestellung</li><li><Check size={17}/>Keine Empfehlung zum größten Paket ohne Bedarf</li><li><Check size={17}/>Leistungsumfang vor Beauftragung schriftlich</li></ul><SmartLink className="button button-gold" href={`/kontakt?bereich=${encodeURIComponent(data.inquiryCta || data.cta)}`}>{data.inquiryCta || data.cta}<ArrowRight size={18}/></SmartLink></div></section>;
}

function ServiceFaq({ data }) {
  const faqs = data.faq || [["Welcher Umfang ist für den Einstieg sinnvoll?", "Das hängt von Ziel, vorhandenen Grundlagen, gewünschtem Start und internen Ressourcen ab. Im Paketfinder erhalten Sie eine erste Orientierung; vor einer Beauftragung wird der Umfang konkret bestätigt."], ["Was ist im Preis nicht automatisch enthalten?", "Fremdkosten, Plattformtarife, Lizenzen, Werbebudgets, Druck, Hosting oder zusätzliche Schnittstellen sind nur enthalten, wenn sie im gewählten Paket ausdrücklich genannt werden."], ["Wie behalte ich während der Umsetzung die Kontrolle?", "Sie erhalten definierte Prüf- und Freigabepunkte. Wesentliche Inhalte, Funktionen und Veröffentlichungen werden nicht ohne Ihre vereinbarte Freigabe abgeschlossen."], ["Was passiert, wenn sich der Umfang verändert?", "Neue Anforderungen werden zuerst hinsichtlich Nutzen, Aufwand, Zeit und Risiken eingeordnet. Eine Erweiterung erfolgt erst nach transparenter Abstimmung."], ["Kann ich klein beginnen und später erweitern?", "Ja. Die Lösungen werden möglichst modular geplant. Entscheidend ist, dass der erste Umfang bereits ein eigenständig nutzbares Ergebnis liefert."]];
  return <section className="service-faq"><header><span>Häufige Fragen vor der Entscheidung</span><h2>Klarheit, bevor Sie anfragen.</h2></header><div>{faqs.map(([question, answer], i) => <details key={question} open={i === 0}><summary><span>{String(i + 1).padStart(2, "0")}</span>{question}<CaretDown size={20}/></summary><p>{answer}</p></details>)}</div></section>;
}
...
function Pricing({ data }) {
  ...
  const commonFeatures = data.commonFeatures || ["Schriftlich definierter Leistungsumfang"];
  const premiumStartIndex = Math.max(0, data.pricing.findIndex((tier) => tier.featured) >= 0 ? data.pricing.findIndex((tier) => tier.featured) : Math.ceil(data.pricing.length / 2));
  const premiumFeatures = (tier) => tierIndex(tier) >= premiumStartIndex ? ["Persönliches Briefing mit Ziel- und Prioritätenklärung", "Erweiterte menschliche Qualitätsprüfung und Freigabe"] : [];
  const ownFeatures = (tier) => tier.features || tier.meta.split(/\s*[·;]\s*/).map((item) => item.trim()).filter(Boolean);
  const tierIndex = (tier) => data.pricing.findIndex((item) => item.name === tier.name);
  ...
  useEffect(() => {
    ...
    const frame = requestAnimationFrame(() => tabsRef.current?.querySelector('[aria-pressed="true"]')?.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" }));
  ...
  const packageDetails = (tier, size = 16) => <>
    ...
    {premiumFeatures(tier).length > 0 && <div className="package-inclusion-group is-premium"><p>Ab dieser Stufe zusätzlich</p><ul>{premiumFeatures(tier).map((item) => <li key={item}><Check size={size}/>{item}</li>)}</ul></div>}
  </>;
  return <section className="pricing-section"><header><span>Paketpreise für Unternehmen</span><h2>Ein klarer Einstieg.<br/>Ein passender Projektumfang.</h2><p>Jede Stufe zeigt ihre Basis, übernommene Leistungen und die zusätzlichen Vorteile. Beratungsformate werden als eigenständige Optionen gekennzeichnet.</p></header><div className={`pricing-grid ${data.pricing.length === 1 ? "is-single" : ""}`}>{data.pricing.map((tier) => <article className={`${tier.featured ? "featured" : ""} ${selected?.name === tier.name ? "is-selected" : ""}`} key={tier.name}>{tier.featured && <b>Häufig gewählt</b>}<h3>{tier.name}</h3><strong>{tier.price}</strong><ul className="pricing-features">{cardFeatures(tier).map((item) => <li key={item}><Check size={15}/>{item}</li>)}</ul><button type="button" aria-haspopup="dialog" onClick={() => choose(tier)}>{selected?.name === tier.name ? "Auswahl & Vergleich öffnen" : data.bookingCta && tier.price !== "auf Anfrage" ? "Paket auswählen" : "Angebot prüfen"} <ArrowRight size={17}/></button></article>)}</div>{selected && !comparisonOpen && <aside className="package-selection-dock" aria-live="polite"><div><small>Ausgewählt</small><strong>{selected.name}</strong><span>{selected.price}</span></div><button type="button" onClick={() => setComparisonOpen(true)}><span className="dock-full">Vergleich öffnen</span><span className="dock-short">Vergleich</span><ArrowUpRight size={16}/></button></aside>}{selected && comparisonOpen && <div className="package-modal-backdrop" role="presentation" onMouseDown={() => setComparisonOpen(false)}><section className="package-modal" role="dialog" aria-modal="true" aria-labelledby="package-modal-title" onMouseDown={(event) => event.stopPropagation()}><header className="package-modal-head"><div><span>Paketauswahl</span><h3 id="package-modal-title">Leistungen klar vergleichen.</h3></div><button type="button" onClick={() => setComparisonOpen(false)} aria-label="Paketvergleich schließen"><X size={23}/></button></header><nav ref={tabsRef} className="package-tabs" aria-label="Pakete vergleichen">{data.pricing.map((tier) => <button type="button" className={tier.name === selected.name ? "is-active" : ""} aria-pressed={tier.name === selected.name} onClick={() => setSelected(tier)} key={tier.name}><span>{tier.name}</span><small>{tier.price}</small></button>)}</nav><div className="package-modal-body"><article className="package-focus"><span>Ihre aktuelle Auswahl</span><h4>{selected.name}</h4><strong>{selected.price}</strong>{selected.featured && <b>Häufig gewählt</b>}{packageDetails(selected)}</article>{data.pricing.length > 1 && <section className="package-alternatives"><header><span>Alle Alternativen</span><h4>Unterschiede auf einen Blick.</h4></header>{data.pricing.filter((tier) => tier.name !== selected.name).map((tier) => <details key={tier.name}><summary><span><strong>{tier.name}</strong><small>{tier.price}</small></span><CaretDown size={19}/></summary>{packageDetails(tier, 15)}<button type="button" onClick={() => setSelected(tier)}>Als Auswahl übernehmen</button></details>)}</section>}</div><footer className="package-modal-actions"><button type="button" onClick={() => setComparisonOpen(false)}>Zurück</button><SmartLink className="button button-gold" href={`/kontakt?bereich=${encodeURIComponent(selected.name)}`}><span className="cta-full">Mit {selected.name} fortfahren</span><span className="cta-short">Anfrage starten</span><ArrowRight size={17}/></SmartLink></footer></section></div>}<p className="pricing-note">{data.note}</p></section>;
}
...
function WebDesignPreview({ entry, compact = false }) {
  ...
  const palette = entry.palettes?.[paletteIndex] || ["#F4EFE6", "#0A2A3F", "#8CA08D", "#C49A55", "#17212A"];
  const copy = {
    botanical: { brand: "VERDEA", eyebrow: "Wissen, das natürlich wirkt", title: "Aus guter Beratung wird echte Veränderung.", text: "Ernährung, Wissen und Alltag in einer ruhigen, klaren Markenwelt verbunden.", offer: "Programme", about: "Philosophie" },
    olive: { brand: "MERAKI HOUSE", eyebrow: "Mediterranean stories", title: "Geschmack hat eine Herkunft.", text: "Ein digitaler Auftritt für Orte, Produkte und Menschen mit Charakter.", offer: "Erlebnisse", about: "Unsere Geschichte" },
    poolside: { brand: "LIDO STUDIO", eyebrow: "Create something memorable", title: "Ideen, die Menschen mitnehmen.", text: "Mutige Gestaltung, klare Angebote und ein Auftritt, der im Kopf bleibt.", offer: "Projekte", about: "Das Studio" },
  }[entry.webTheme];
  const sectionCopy = section === "about" ? [copy.about, "Die Geschichte hinter der Marke", "Haltung, Herkunft und Persönlichkeit werden nicht versteckt, sondern zum roten Faden der Website."] : section === "offer" ? [copy.offer, "Angebote klar und wertig präsentieren", "Leistungen werden verständlich strukturiert, damit Besucher schneller erkennen, was zu ihnen passt."] : [copy.eyebrow, copy.title, copy.text];
  return <div className={`web-demo ${compact ? "is-compact" : ""}`} style={{ "--demo-bg": palette[0], "--demo-primary": palette[1], "--demo-soft": palette[2], "--demo-accent": palette[3], "--demo-ink": palette[4] }}>
    <div className="web-demo-browser"><i/><i/><i/><span>{entry.title.toLowerCase().replaceAll(" ", "-")}.studio</span></div>
    <div className="web-demo-page">
      <nav><strong>{copy.brand}</strong><div><button type="button" className={section === "start" ? "is-active" : ""} onClick={() => !compact && setSection("start")}>Start</button><button type="button" className={section === "about" ? "is-active" : ""} onClick={() => !compact && setSection("about")}>{copy.about}</button><button type="button" className={section === "offer" ? "is-active" : ""} onClick={() => !compact && setSection("offer")}>{copy.offer}</button></div></nav>
      <section><div><small>{sectionCopy[0]}</small><h3>{sectionCopy[1]}</h3><p>{sectionCopy[2]}</p><span>Mehr entdecken <ArrowRight size={compact ? 10 : 15}/></span></div><div className="web-demo-visual"><img src={entry.image} alt=""/><i/></div></section>
      <footer><span>Strategie</span><span>Design</span><span>Umsetzung</span></footer>
    </div>
    {!compact && <div className="web-demo-controls"><span>Farbwelt auswählen</span><div>{entry.palettes.map((colors, index) => <button type="button" className={index === paletteIndex ? "is-active" : ""} onClick={() => setPaletteIndex(index)} aria-label={`Farbwelt ${index + 1}`} aria-pressed={index === paletteIndex} key={colors.join("")}><i style={{background: colors[1]}}/><i style={{background: colors[2]}}/><i style={{background: colors[3]}}/></button>)}</div><small>Klicken Sie auch auf die Menüpunkte in der Vorschau.</small></div>}
  </div>;
}
...
function LabPage() {
  ...
  useEffect(() => {
    ...
    const previous = document.body.style.overflow;
    document.body.style.overflow = "hidden";
    const close = (event) => { if (event.key === "Escape" && !zoomImage) setDetail(null); };
  ...
  useEffect(() => {
    ...
    setZoomLevel(1);
    const close = (event) => { if (event.key === "Escape") setZoomImage(null); };
    document.addEventListener("keydown", close);
  ...
  return <main id="main">
    ...
    {detail && <div className="design-detail-backdrop" role="presentation" onMouseDown={() => setDetail(null)}><section className={`design-detail ${detail.webTheme ? "is-web-demo" : ""}`} role="dialog" aria-modal="true" aria-labelledby="design-detail-title" onMouseDown={(event) => event.stopPropagation()}><button className="design-detail-close" type="button" onClick={() => setDetail(null)} aria-label="Detailansicht schließen"><X size={22}/></button><figure>{detail.webTheme ? <WebDesignPreview entry={detail}/> : <button className="design-detail-image" type="button" onClick={() => setZoomImage(detail)} aria-label={`${detail.title} im Vollbild öffnen`}><img src={detail.image} alt={`Designansicht ${detail.title}`} width="1536" height="1024"/><span><MagnifyingGlassPlus size={18}/> Vollbild & Zoom</span></button>}</figure><div className="design-detail-copy"><span className="design-area-label">{detail.area}</span><h2 id="design-detail-title">{detail.title}</h2><p>{detail.details || detail.text}</p>{detail.category === "Bücher" ? <><div className="design-package-choice"><label htmlFor="book-package">Gewünschter Buchumfang</label><select id="book-package" value={bookPackage} onChange={(event) => setBookPackage(event.target.value)}><option>Book Starter · ab 1.000 €</option><option>Authority Book · 3.000 €</option><option>Premium Research Book · 6.000 €</option><option>Individuelles Buchprojekt · auf Anfrage</option></select><small>Die Vorlage bestimmt die Designrichtung. Seitenzahl, Recherche, Ghostwriting, Lektorat, Bilder und Druck richten sich nach dem gewählten Paket und dem verbindlichen Angebot.</small></div><SmartLink className="button button-gold" href={`/kontakt?bereich=${encodeURIComponent(`${detail.title} · ${bookPackage}`)}`}>Design & Paket anfragen <ArrowRight size={18}/></SmartLink></> : <SmartLink className="button button-gold" href={detail.webTheme ? `/kontakt?bereich=${encodeURIComponent(`Webdesign ${detail.title}`)}` : detail.href}>{detail.webTheme ? "Webdesign anfragen" : "Passenden Bereich öffnen"} <ArrowRight size={18}/></SmartLink>}<button type="button" className="design-save" aria-pressed={saved.includes(detail.title)} onClick={() => toggle(detail.title)}>{saved.includes(detail.title) ? "Aus Auswahl entfernen" : "Als Vorlage merken"}</button></div></section></div>}
    {zoomImage && <div className="design-zoom" role="dialog" aria-modal="true" aria-label={`${zoomImage.title} Vollbildansicht`}><header><div><small>Designansicht</small><strong>{zoomImage.title}</strong></div><div className="design-zoom-controls"><button type="button" onClick={() => setZoomLevel((value) => Math.max(1, value - .5))} disabled={zoomLevel <= 1} aria-label="Verkleinern"><MagnifyingGlassMinus size={21}/></button><span>{Math.round(zoomLevel * 100)} %</span><button type="button" onClick={() => setZoomLevel((value) => Math.min(4, value + .5))} disabled={zoomLevel >= 4} aria-label="Vergrößern"><MagnifyingGlassPlus size={21}/></button><button type="button" onClick={() => setZoomImage(null)} aria-label="Vollbild schließen"><X size={23}/></button></div></header><div className="design-zoom-stage" onDoubleClick={() => setZoomLevel((value) => value === 1 ? 2 : 1)}><img src={zoomImage.image} alt={`Vergrößerte Designansicht ${zoomImage.title}`} style={{width: `${zoomLevel * 100}%`}} draggable="false"/></div><footer>Mit zwei Fingern verschieben · Doppeltippen oder die Tasten zum Zoomen verwenden</footer></div>}
  </main>;
}
